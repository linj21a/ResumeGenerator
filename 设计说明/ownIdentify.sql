/******************************************/
/*   DatabaseName = ownidentify   */
/*   TableName = ownidentify_edu   */
/******************************************/
CREATE TABLE `ownidentify_edu` (
...
/******************************************/
/*   DatabaseName = ownidentify   */
/*   TableName = ownidentify_skill   */
/******************************************/
CREATE TABLE `ownidentify_skill` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `userid` int(20) DEFAULT NULL COMMENT '用户编号',
...
/******************************************/
/*   DatabaseName = ownidentify   */
/*   TableName = ownidentify_specialty   */
/******************************************/
CREATE TABLE `ownidentify_specialty` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `userid` int(20) DEFAULT NULL COMMENT '用户编号',
...
/******************************************/
/*   DatabaseName = ownidentify   */
/*   TableName = ownidentify_user   */
/******************************************/
CREATE TABLE `ownidentify_user` (
...
/******************************************/
/*   DatabaseName = ownidentify   */
/*   TableName = ownidentify_work   */
/******************************************/
CREATE TABLE `ownidentify_work` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `userid` int(20) DEFAULT NULL COMMENT '用户编号',
