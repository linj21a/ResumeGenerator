...
public class UserDaoImp implements BaseDao<User>{
    private static final String SQL_INSERT = "insert into ownidentify_user(name,age,city,address,email,phone,weixin,qq,weibo,sex,description) values(?,?,?,?,?,?,?,?,?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from ownidentify_user where id=?";
