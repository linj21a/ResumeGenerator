...
import com.Code.bean.Specialty;
...
public class SpecialtyDaoImp implements BaseDao<Specialty> {
    ...
    private static final String SQL_INSERT = "insert into ownidentify_specialty(userid,name,description) values(?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from ownidentify_specialty where userid=?";
